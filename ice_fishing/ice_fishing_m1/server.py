...
m_belief = mpl.cm.ScalarMappable(cmap=mpl.colormaps['Blues'], norm=mpl.colors.Normalize(vmin=0, vmax=.1))
...
server = mesa.visualization.ModularServer(
    IceFishingModel, [grid, grid_belief_prior, grid_belief_catch, grid_belief_social], "Ice Fishing", model_params
)
